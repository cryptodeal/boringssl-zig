...
pub fn build(b: *std.Build) void {
    ...
    libcrypto.addCSourceFiles(.{ .files = bcm_sources, .flags = &.{"-DBORINGSSL_IMPLEMENTATION"} });
    libcrypto.addCSourceFiles(.{ .files = crypto_sources, .flags = &.{"-DBORINGSSL_IMPLEMENTATION"} });
    libcrypto.addCSourceFiles(.{ .files = bcm_sources_asm, .flags = &.{"-DBORINGSSL_IMPLEMENTATION"} });
    libcrypto.addCSourceFiles(.{ .files = crypto_sources_asm, .flags = &.{"-DBORINGSSL_IMPLEMENTATION"} });
    ...
    libssl.addIncludePath(b.path("include"));
    libssl.installHeadersDirectory(b.path("include"), "", .{});
    libssl.addCSourceFiles(.{ .files = ssl_sources, .flags = &.{"-DBORINGSSL_IMPLEMENTATION"} });
    b.installArtifact(libssl);

    const bssl = b.addStaticLibrary(.{
        .name = "bssl",
        .target = target,
        .optimize = optimize,
    });
    ...
    bssl.addIncludePath(b.path("include"));
    bssl.addCSourceFiles(.{ .files = bssl_sources, .flags = &.{} });
    ...
    libdecrepit.addIncludePath(b.path("include"));
    libdecrepit.addCSourceFiles(.{ .files = decrepit_sources, .flags = &.{"-DBORINGSSL_IMPLEMENTATION"} });
    ...
    libpki.linkLibrary(libssl);
    libpki.addIncludePath(b.path("include"));
    libpki.addCSourceFiles(.{ .files = pki_sources, .flags = &.{"-DBORINGSSL_IMPLEMENTATION"} });
    b.installArtifact(libpki);
}

const bcm_sources = &.{"crypto/fipsmodule/bcm.c"};

const bcm_internal_headers = &.{
...
const decrepit_internal_headers = &.{
    "decrepit/cast/internal.h",
    "decrepit/macros.h",
};

const decrepit_test_sources = &.{
    "crypto/test/gtest_main.cc",
...
const ssl_internal_headers = &.{
    "ssl/internal.h",
};

const ssl_test_sources = &.{
    "crypto/test/gtest_main.cc",
    "ssl/span_test.cc",
    "ssl/ssl_c_test.c",
    "ssl/ssl_test.cc",
...
const test_support_internal_headers = &.{
...
const test_support_sources_asm = &.{
